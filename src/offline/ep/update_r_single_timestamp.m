function [Qr_t_new, Qr_joint_new] = update_r_single_timestamp(t, Qh_t, Qh_joint, Qr_t, Qr_joint, Qu_t, Qu_t_plus_1, Qu_joint, Sigma, ...
...
if t == 1
    ...
    mu.cavity.mean = Qu_t_plus_1.mu_previous.mean;
elseif t < T
...
Qr_joint_new.mu.common_var = bound_values_matrix(Qr_joint_new.mu.common_var, min_var, max_var, run_checks);
