function [Qu_t_new, Qu_joint_new] = update_u_single_timestamp_with_u1(t, Qu_t, Qu_tm1, Qu_t_plus_1, Qu_joint, ...
...
Qu_joint_new.mu.common_var = bound_values_matrix(Qu_joint_new.mu.common_var, min_var, max_var);
