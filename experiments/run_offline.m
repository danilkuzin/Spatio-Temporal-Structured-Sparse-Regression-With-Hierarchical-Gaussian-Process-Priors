function results = run_offline(beta, X, y, eta, eta_multiplier)
% function that performs offline ep inference for the sparse 
...
% inference. 
    ...
    [results] = ep_func(Sigma, W, N, T, X, y, run_checks, ...
        sigma2_beta, K, sigma2, epseps, eta, eta_multiplier, mu0, available_omega, available_beta, eta_alls, max_iter_num, beta);
